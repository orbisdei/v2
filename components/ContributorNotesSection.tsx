...
const STYLES = {
  sm: {
    ...
    textarea: 'w-full border border-gray-200 rounded-lg px-3 py-2 text-[12px] resize-none focus:outline-hidden focus:ring-2 focus:ring-navy-300',
  ...
  md: {
    ...
    textarea: 'w-full border border-gray-200 rounded-lg px-3 py-2 text-sm resize-none focus:outline-hidden focus:ring-2 focus:ring-navy-300',
