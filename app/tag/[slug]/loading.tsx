    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col lg:flex-row animate-pulse">
        <div className="w-full lg:w-1/2 xl:w-[45%] px-4 py-6 lg:px-8">
          <div className="h-5 w-32 bg-gray-200 rounded-sm mb-4" />
          <div className="h-8 w-2/3 bg-gray-200 rounded-sm mb-3" />
          <div className="space-y-2 mb-6">
            <div className="h-4 w-full bg-gray-200 rounded-sm" />
            <div className="h-4 w-5/6 bg-gray-200 rounded-sm" />
          </div>
          <div className="h-5 w-24 bg-gray-200 rounded-sm mb-3" />
