    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col lg:flex-row animate-pulse">
        <div className="w-full lg:w-1/2 xl:w-[45%] px-4 py-6 lg:px-8">
          <div className="h-5 w-28 bg-gray-200 rounded-sm mb-4" />
          <div className="h-8 w-3/4 bg-gray-200 rounded-sm mb-2" />
          <div className="h-4 w-1/2 bg-gray-200 rounded-sm mb-6" />
          <div className="h-5 w-20 bg-gray-200 rounded-sm mb-3" />
